...
export const FAQ: React.FC = () => {
  ...
  return (
    <div className="bg-white min-h-screen pb-24 font-sans text-gray-900">
      ...
      {/* ─── Premium Hero ─────────────────────────────────────────── */}
      <div className="relative h-[420px] overflow-hidden bg-secondary border-b-4 border-accent pt-[80px]">
        {/* BG image */}
        ...
        <div className="absolute inset-0 flex flex-col justify-center z-10 pt-[80px]">
          <div className="container mx-auto px-4 md:px-8">
            <div className="max-w-4xl animate-fade-in-up">
              ...
              <p className="text-gray-200 font-medium max-w-2xl leading-relaxed mb-6" style={{ fontSize: '18px' }}>
