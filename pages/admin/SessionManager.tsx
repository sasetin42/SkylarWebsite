      ...
      {isEditing ? (
          <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-lg border border-gray-200 dark:border-gray-700 animate-fade-in">
             ...
             <form onSubmit={handleSave} className="grid md:grid-cols-2 gap-6">
                <div>
                    <label htmlFor="session-course" className="block text-sm font-bold mb-1 text-gray-700 dark:text-gray-300">Course</label>
                ...
                <div>
                    <label htmlFor="session-trainer" className="block text-sm font-bold mb-1 text-gray-700 dark:text-gray-300">Trainer</label>
                ...
                <div>
                    <label htmlFor="session-capacity" className="block text-sm font-bold mb-1 text-gray-700 dark:text-gray-300">Capacity</label>
                ...
                <div>
                    <label htmlFor="session-start-date" className="block text-sm font-bold mb-1 text-gray-700 dark:text-gray-300">Start Date</label>
                 ...
                 <div>
                    <label htmlFor="session-end-date" className="block text-sm font-bold mb-1 text-gray-700 dark:text-gray-300">End Date</label>
                 ...
                 <div>
                    <label htmlFor="session-status" className="block text-sm font-bold mb-1 text-gray-700 dark:text-gray-300">Status</label>
