...
export const ComplianceManager: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-fade-in-up">
      <div>
         <h2 className="text-2xl font-bold font-heading text-secondary dark:text-white">Compliance & GWO Standards</h2>
            ...
            <table className="w-full text-left text-sm">
                <thead className="bg-gray-50 dark:bg-gray-700/50 text-gray-600 dark:text-gray-300 font-bold uppercase text-xs">
                    <tr>
                        ...
                        <th className="px-4 py-3">GWO Trainer Cert</th>
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                    {trainers.map(t => (
                        <tr key={t.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            ...
                            <td className="px-4 py-4 text-gray-500 dark:text-gray-400">Current</td>
